...
public class CommUtil
{
	 ...
	 * @return
	 * @author shaolin
	 * @time 2017年9月12日 上午10:06:24
	 */
	public static double formatMoneyByType(Object money, String type)
	{
	 ...
	 */
	public static Date getStartTimeOfDay(String date) throws ParseException
	{
		Calendar day = Calendar.getInstance();
		day.setTime(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").parse(date));
		day.set(Calendar.HOUR_OF_DAY, 0);
		day.set(Calendar.MINUTE, 0);
		day.set(Calendar.SECOND, 0);
		day.set(Calendar.MILLISECOND, 0);
	 ...
	 * @throws ParseException 
	 */
	public static Date getEndTimeOfDay(String date) throws ParseException
	{
		Calendar day = Calendar.getInstance();
		day.setTime(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").parse(date));
		day.set(Calendar.HOUR_OF_DAY, 23);
	 ...
	 * String类型转成Date类型
	 * 
	 * @param date type=1 yyyy年MM月dd日 type=2 yyyy-MM-dd HH:mm:ss type=3 yyyy-MM-dd
	 *            HH:mm type=4 yyyy-MM-dd HH type=其他 yyyy-MM-dd
	 * @author shaolin
	 */
	public static Date StringToDate(String date, int type) throws Exception
	{
		if (null == date)
		{
	...
	public static String addFrontZeroFor(Object o)
	{
		String str = "0000000000";
		String ostr = o.toString();
		return str.substring(0, str.length() - ostr.length()) + ostr;
	}
